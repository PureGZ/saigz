...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
    	<form class="mws-form" action="{{url('/articles')}}" method="post" enctype="multipart/form-data">
    		<div class="mws-form-inline">
    			...
    			<div class="mws-form-row">
    				...
    				<div class="mws-form-item">
    					<textarea id="editor" rows="" cols="" style="height:300px;"  name="content"></textarea>
    				</div>
    			</div>
