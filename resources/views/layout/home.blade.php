...
<html>
	<head>
		...
		<meta name="keywords" content="php laravel mysql" />
							...
							<aside class="sidebar">
								...
								<div class="tabs">
									<ul class="nav nav-tabs">
										<li  class="active"><a href="#recentPosts" data-toggle="tab">最新文章</a></li>
									</ul>
									<div class="tab-content">
										<?php $recent = \App\Article::orderBy('id','desc')->take(3)->get(); ?>
												...
												<li>
													<div class="post-image">
														<div class="img-thumbnail">
															<img src="{{$v->img}}" class="img-responsive" width="100" alt="">
														</div>
													</div>
													<div class="post-info">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<nav id="sub-menu">
									...
									<ul>
										<li><a href="page-faq.html">GitHub</a></li>
										<li><a href="sitemap.html">WeChat</a></li>
										<li><a href="contact-us.html">Email</a></li>
									</ul>
								</nav>
							</div>
						</div>
